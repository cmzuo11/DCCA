...
class DCCA_missing(nn.Module):
    ...
    def fit_model( self, train_loader_inter = None, test_loader_inter = None, total_loader = None, test_cluster= None):
    ...
    def evluation_metrics(self, dataloader):
        ...
        print('scRNA-ARI: ' + str(ARI_score1) + ' NMI: ' + str(NMI_score1) + 
              ' scEpigenomics-ARI: ' + str(ARI_score2) + ' NMI: ' + str(NMI_score2) )
    ...
    def inference_other_from_rna( self, RNA_data_loader ):
        ...
        for batch_idx, ( X1, _, size_factor1 ) in enumerate(RNA_data_loader): 
            ...
            recons_data.append( recons_y.data.cpu().numpy() )

        recons_data = np.concatenate(recons_data)
