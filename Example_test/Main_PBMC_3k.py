...
def train_with_argas( args ):
    ...
    args.File1      =  os.path.join( args.workdir, 'rna_data_2874cell_1500genes.txt' )
    args.File2      =  os.path.join( args.workdir, 'atac_data_2874cell_11063loci_binary.txt' ) 
    args.File3      =  os.path.join( args.workdir, 'pbmc_3k_cell_cluster_2874.txt' ) 
